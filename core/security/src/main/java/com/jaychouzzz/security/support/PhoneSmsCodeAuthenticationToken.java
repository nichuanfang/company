 ...
 * @author Ben Alex
 */
public class PhoneSmsCodeAuthenticationToken extends AbstractAuthenticationToken {
     ...
     *
     */
    public PhoneSmsCodeAuthenticationToken(Object principal, Object credentials) {
        super(null);
